...
# TEST 5
echo -e "\n5. Attempting to see all listed files. There should be AT LEAST fall_in_winter.txt and summer_in_maine.txt."
echo -e "--------------------------------------------------------------------------------\n"
...
# TEST 7
echo -e "\n7. Attempting to decrypt file, with the wrong password. It should give an integrity/password alert."
echo -e "--------------------------------------------------------------------------------\n"
./bin/cstore extract -p oops seasons fall_in_nyc.txt

# TEST 8
echo -e "\n8. Attempting to delete file, with the wrong password. It should give an integrity/password alert."
echo -e "--------------------------------------------------------------------------------\n"
./bin/cstore delete -p oops seasons fall_in_nyc.txt

# TEST 9
echo -e "\n9. Attempting to delete file, with the correct password. It should succeed."
echo -e "--------------------------------------------------------------------------------\n"
./bin/cstore delete -p pass seasons fall_in_nyc.txt

# TEST 10
echo -e "\n10. Attempting to delete file, which exists, but with a typo. It should alert there is no file."
echo -e "--------------------------------------------------------------------------------\n"
